...
class MCTS(SingleBehaviorRedTeamingMethod):
    def __init__(self, 
                 judge_model,
                 target_model,
                 batch_size=128,
        ...
        # Initialization
        self.prompt_generator = MctsPromptGenerator(self.judge_modle_config, self.target_model_config, self.response_length, self.prompt_length_threshold, self.threshold, self.chat_template, self.use_chat_template)
