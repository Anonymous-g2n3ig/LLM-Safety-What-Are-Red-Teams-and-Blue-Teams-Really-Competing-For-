...
class Exh(SingleBehaviorRedTeamingMethod):
    ...
    def generate_test_cases_single_behavior(self, behavior_dict, verbose, **kwargs):
        ...
        test_case, response = self.prompt_generator.generate_adv_prompt(test_case, batch_size, self.top_p, self.top_k, beam_width=self.beam_width, behavior_dict=behavior_dict)
